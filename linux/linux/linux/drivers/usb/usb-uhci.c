 ...
 *
 * $Id: usb-uhci.c,v 1.1.1.1 2012/08/29 05:42:24 bcm5357 Exp $
 */
...
_static int uhci_submit_iso_urb (struct urb *urb)
{
	...
	tdm = (uhci_desc_t **) kmalloc (urb->number_of_packets * sizeof (uhci_desc_t*), GFP_ATOMIC);
...
#ifdef DEBUG_SLAB
	urb_priv = kmem_cache_alloc(urb_priv_kmem, SLAB_ATOMIC);
#else
