 ...
 *  more details.
 *
 *  $Header: /usr/kcvsrep/broadcom_sdk/bcm_5.110.27.9/src/linux/linux/drivers/video/pm3fb.h,v 1.1.1.1 2012/08/29 05:42:24 bcm5357 Exp $
 *
 */
...
#if ((LINUX_VERSION_CODE >= KERNEL_VERSION(2,4,0)) && (LINUX_VERSION_CODE < \
	KERNEL_VERSION(2,5,0)))
#define KERNEL_2_4
#endif

#if ((LINUX_VERSION_CODE >= KERNEL_VERSION(2,2,0)) && (LINUX_VERSION_CODE < \
...
/* ******************************************** */
#ifdef KERNEL_2_2
#ifdef MUST_BYTESWAP     /* we are writing big_endian to big_endian through a \
	little_endian macro */
