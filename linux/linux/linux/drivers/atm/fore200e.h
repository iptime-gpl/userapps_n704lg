/* $Id: fore200e.h,v 1.1.1.1 2012/08/29 05:42:23 bcm5357 Exp $ */
#ifndef _FORE200E_H
#define _FORE200E_H
...
#    if (PCI_DMA_BIDIRECTIONAL == SBUS_DMA_BIDIRECTIONAL) && (PCI_DMA_TODEVICE      == \
	SBUS_DMA_TODEVICE)      && (PCI_DMA_FROMDEVICE    == SBUS_DMA_FROMDEVICE)
