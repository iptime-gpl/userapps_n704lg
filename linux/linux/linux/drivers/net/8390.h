...
#if defined(CONFIG_MAC) || defined(CONFIG_ARIADNE2) || defined(CONFIG_ARIADNE2_MODULE) \
	|| defined(CONFIG_HYDRA) || defined(CONFIG_HYDRA_MODULE) || defined(CONFIG_ARM_ETHERH) \
	|| defined(CONFIG_ARM_ETHERH_MODULE)
