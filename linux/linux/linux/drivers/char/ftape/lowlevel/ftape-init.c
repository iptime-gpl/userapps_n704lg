...
/*      Global vars.
 */
char ft_src[] __initdata = "$Source: /usr/kcvsrep/broadcom_sdk/bcm_5.110.27.9/src/linux/linux/drivers/char/ftape/lowlevel/ftape-init.c,v $";
char ft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char ft_dat[] __initdata = "$Date: 2012/08/29 05:42:24 $";
