 ...
 */
 ...
 char zftc_src[] ="$Source: /usr/kcvsrep/broadcom_sdk/bcm_5.110.27.9/src/linux/linux/drivers/char/ftape/compressor/zftape-compress.c,v $";
 char zftc_rev[] = "$Revision: 1.1.1.1 $";
 char zftc_dat[] = "$Date: 2012/08/29 05:42:24 $";
