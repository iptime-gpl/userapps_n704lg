 ...
 *
 * Version:	$Id: route.c,v 1.2 2009/11/05 01:14:17 bcmnew Exp $
 *
...
#ifdef CONFIG_IP_ROUTING_CACHE_LIMIT
int ip_rt_gc_timeout            = CONFIG_ROUTING_GC_TIMEOUT * HZ;
int ip_rt_gc_interval           = CONFIG_ROUTING_GC_INTERVAL * HZ;
#else
...
#ifdef CONFIG_IP_ROUTING_CACHE_LIMIT
	ip_rt_max_size = CONFIG_ROUTING_CACHE_SIZE;
#else
