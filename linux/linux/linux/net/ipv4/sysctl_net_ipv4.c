 ...
 *
 * $Id: sysctl_net_ipv4.c,v 1.3 2009/12/15 06:52:41 bcmnew Exp $
 *
	...
	{NET_TCP_TW_REUSE, "tcp_tw_reuse",
	 &sysctl_tcp_tw_reuse, sizeof(int), 0644, NULL, &proc_dointvec},
        ...
        {NET_FORWARD_SPEED_UP_FLAG, "forward_speed_up_flag",
         &sysctl_forward_speed_up_flag, sizeof(int), 0644, NULL,
         &proc_dointvec},
#endif
#ifdef CONFIG_PASSTHROUGH_ALL_CHAIN
        {NET_NAT_PASSTHROUGH, "nat_passthrough_flag",
         &sysctl_nat_passthrough_flag, sizeof(int), 0644, NULL,
         &proc_dointvec},
#endif
#if defined(CONFIG_IP_NF_NAT_ISPFAKE) || defined(CONFIG_IP_NF_NAT_ISPFAKE_MODULE)
	{NET_TCP_MSS_ISPFAKE, "tcp_mss_ispfake",
	 &sysctl_tcp_mss_ispfake, sizeof(int), 0644, NULL,
	 &proc_dointvec},
#endif
	{0}
};
